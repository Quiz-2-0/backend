    ...
    operations = [
        ...
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('role', models.CharField(choices=[('AD', 'Admin'), ('EMP', 'Employee')], default='EMP', max_length=5, verbose_name='role')),
                ...
                ('score', models.PositiveSmallIntegerField(blank=True, help_text='score', null=True)),
                ('department', models.ForeignKey(blank=True, null=True, on_delete=django.db.models.deletion.SET_NULL, related_name='departament', to='user.department', verbose_name='department')),
